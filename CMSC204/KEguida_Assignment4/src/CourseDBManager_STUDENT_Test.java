...
public class CourseDBManager_STUDENT_Test {
	...
	public void testRead() {
		try {
			/*Make sure courses.txt from the assignment 4 folder is in the src directory for this 
			  test to pass
			*/
			...
			assertEquals("HT300",dataMgr.get(20484).getRoomNum());
			assertEquals("Sascha Simkanich",dataMgr.get(23363).getInstructor().trim());
		} catch (Exception e) {
